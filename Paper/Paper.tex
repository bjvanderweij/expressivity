...
A performance rendering system is a computer program that automatically creates an expressive, humanlike performance of a musical score. Early attempts like Director Musices REF have tried to create use sets of rules to create performances. These systems
Expressively performing a musical score is known as performance rendering. A performance rendering system aims to create automate A yearly competition is held among performance rendering systems 
...
The segmentation was based only delta onset trees since this worked best for Mozart. 
