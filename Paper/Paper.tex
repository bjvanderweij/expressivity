...
The goal is to find a `safe' method to segment music, that is, a method that does not generate segmentations that clash too much with human musical intuition. For this purpose the delta trees of note onset and pitch seem most suited: sudden jumps in pitch or onset often correspond to phrase transitions. 
...
\begin{itemize}
\item We are talking about SCOREfeatures here, mention this ( has now been mentioned in approach)
\end{itemize}
